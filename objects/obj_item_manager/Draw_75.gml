...
//icon
	...
	draw_sprite (inv[0].icon, 0, 229, 661)
...
//description
	if selected_item == i
	{
	draw_text_ext(900, 550, inv[i].description, 24, 300)
	}
...
//draw selected item number
draw_text(obj_player.x, obj_player.y, selected_item);
