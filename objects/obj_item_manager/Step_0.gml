...
//create bag tab buttons
if inventory_open == 1
{	
	instance_create_layer(camera_get_view_x(0)+1820,camera_get_view_y(0)+10,"instances_gui_buttons", obj_crafting_tab);
}